    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a class="btn btn-primary navbar-btn login">Giriş Yap</a>
                </li>
                ...
                <div class="panel-body">
                    <form class="form" action="">
                        <div class="form-group">
                            <input type="search" placeholder="Şikayet veya marka arayın..." class="form-control"/>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin congue rhoncus
                                vulputate. Curabitur eget venenatis sapien. Mauris tempor sollicitudin purus, a
                                elementum mi consectetur nec.</p>
                        </div>
                    </div>
                </div>
